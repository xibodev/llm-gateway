...
| `HTTP-001D` | `queued` | none | Bound individual SSE/NDJSON records without limiting valid stream duration. Oversized records fail safely and normal Chat, Responses, and Messages fixtures remain compatible. |
