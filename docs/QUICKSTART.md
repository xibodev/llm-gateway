...
services:
  gateway:
    image: ghcr.io/xibodev/llm-gateway:0.5.1
    ports:
...
This recipe pins [v0.5.1](https://github.com/xibodev/llm-gateway/releases/tag/v0.5.1).
...
[SHA256SUMS](https://github.com/xibodev/llm-gateway/releases/download/v0.5.1/SHA256SUMS):

| Platform | v0.5.1 download |
| --- | --- |
| Windows x64 | [windows_amd64.zip](https://github.com/xibodev/llm-gateway/releases/download/v0.5.1/llmgw_v0.5.1_windows_amd64.zip) |
| Linux x64 | [linux_amd64.tar.gz](https://github.com/xibodev/llm-gateway/releases/download/v0.5.1/llmgw_v0.5.1_linux_amd64.tar.gz) |
| Linux ARM64 | [linux_arm64.tar.gz](https://github.com/xibodev/llm-gateway/releases/download/v0.5.1/llmgw_v0.5.1_linux_arm64.tar.gz) |
| macOS Intel | [darwin_amd64.tar.gz](https://github.com/xibodev/llm-gateway/releases/download/v0.5.1/llmgw_v0.5.1_darwin_amd64.tar.gz) |
| macOS Apple Silicon | [darwin_arm64.tar.gz](https://github.com/xibodev/llm-gateway/releases/download/v0.5.1/llmgw_v0.5.1_darwin_arm64.tar.gz) |
...
```bash
sha256sum llmgw_v0.5.1_linux_amd64.tar.gz
tar -xzf llmgw_v0.5.1_linux_amd64.tar.gz
```
...
```powershell
Get-FileHash .\llmgw_v0.5.1_windows_amd64.zip -Algorithm SHA256
Expand-Archive .\llmgw_v0.5.1_windows_amd64.zip -DestinationPath .
```
...
```bash
git clone --branch v0.5.1 https://github.com/xibodev/llm-gateway.git
cd llm-gateway
```
